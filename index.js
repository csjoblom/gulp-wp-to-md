...
module.exports = function(file, opt) {
    if(!file) {
        throw new PluginError('gulp-wp-to-md', 'Missing file option for gulp-wp-to-md');
    }
    opt = opt || {};
    ...
    if (typeof file === 'string') {
        ...
        throw new PluginError('gulp-wp-to-md', 'Missing path in file options for gulp-wp-to-md');
    }
    ...
    function bufferContents(file, encode, callback) {
        ...
        if (file.isStream()) {
             this.emit('error', new PluginError('gulp-wp-to-md', 'Steaming not supported'));
             callback();
             return;
        }
    ...
    function endStream(callback) {
        ...
        if (typeof file === 'string') {
            convertedFile = latestFile.clone({contents: false});
